...
class BaiduFy(WebService):
    ...
    def fld_uk_audio(self):
        audiourl = "http://tts.baidu.com/text2audio?lan=uk&pid=101&ie=UTF-8&text={}&spd=4".format(
            self.quote_word
        )
    ...
    def fld_en_audio(self):
        audiourl = "http://tts.baidu.com/text2audio?lan=en&pid=101&ie=UTF-8&text={}&spd=4".format(
            self.quote_word
        )
        audio = requests.get(audiourl)
