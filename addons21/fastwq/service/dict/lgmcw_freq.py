...
DICT_PATH = "/Users/brian/Documents/mdx/lgmcw_Sound++/SoundMobile.mdx"  # u'E:\\BaiduYunDownload\\mdx\\L6mp3.mdx'


@register(["本地词典-lgmcw_Sound++", "lgmcw_Sound++"])
    ...
    def __init__(self):
        ...
        if not dict_path:
            ...
            for clazz in service_manager.mdx_services:
                ...
                if title.startswith("SoundMobile"):
