...
class EnglishStemmer(BaseStemmer):
    ...
    a_0 = [Among("arsen", -1, -1), Among("commun", -1, -1), Among("gener", -1, -1)]

    a_1 = [Among("'", -1, 1), Among("'s'", 0, 1), Among("'s", -1, 1)]
    ...
    def r_Step_2(self):
        ...
        if among_var == 0:
            ...
            # (, line 101
            # <-, line 101
            if not self.slice_from("tion"):
                return False
        elif among_var == 2:
            # (, line 102
            # <-, line 102
            if not self.slice_from("ence"):
                return False
        elif among_var == 3:
            # (, line 103
            # <-, line 103
            if not self.slice_from("ance"):
                return False
        elif among_var == 4:
            # (, line 104
            # <-, line 104
            if not self.slice_from("able"):
                return False
        elif among_var == 5:
            # (, line 105
            # <-, line 105
            ...
            # (, line 107
            # <-, line 107
            if not self.slice_from("ize"):
                return False
        elif among_var == 7:
            # (, line 109
            # <-, line 109
            if not self.slice_from("ate"):
                return False
        elif among_var == 8:
            # (, line 111
            # <-, line 111
            ...
            # (, line 112
            # <-, line 112
            if not self.slice_from("ful"):
                return False
        elif among_var == 10:
            # (, line 114
            # <-, line 114
            if not self.slice_from("ous"):
                return False
        elif among_var == 11:
            # (, line 116
            # <-, line 116
            if not self.slice_from("ive"):
                return False
        elif among_var == 12:
            # (, line 118
            # <-, line 118
            if not self.slice_from("ble"):
                return False
        elif among_var == 13:
            # (, line 119
            # literal, line 119
            if not self.eq_s_b(1, "l"):
                return False
            # <-, line 119
            if not self.slice_from("og"):
                return False
        elif among_var == 14:
            # (, line 120
            # <-, line 120
    ...
    def r_exception1(self):
        ...
        if among_var == 0:
            ...
            # (, line 174
            # <-, line 174
            if not self.slice_from("ski"):
                return False
        elif among_var == 2:
            # (, line 175
            # <-, line 175
            if not self.slice_from("sky"):
                return False
        elif among_var == 3:
            # (, line 176
            # <-, line 176
            if not self.slice_from("die"):
                return False
        elif among_var == 4:
            # (, line 177
            # <-, line 177
            if not self.slice_from("lie"):
                return False
        elif among_var == 5:
            # (, line 178
            # <-, line 178
            if not self.slice_from("tie"):
                return False
        elif among_var == 6:
            # (, line 182
            # <-, line 182
            if not self.slice_from("idl"):
                return False
        elif among_var == 7:
            # (, line 183
            # <-, line 183
            if not self.slice_from("gentl"):
                return False
        elif among_var == 8:
            # (, line 184
            # <-, line 184
            if not self.slice_from("ugli"):
                return False
        elif among_var == 9:
            # (, line 185
            # <-, line 185
            if not self.slice_from("earli"):
                return False
        elif among_var == 10:
            # (, line 186
            # <-, line 186
            if not self.slice_from("onli"):
                return False
        elif among_var == 11:
            # (, line 187
            # <-, line 187
            if not self.slice_from("singl"):
                return False
        return True
